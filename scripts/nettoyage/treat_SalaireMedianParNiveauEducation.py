...
import pandas as pd
import numpy as np
from utils import EUROPEAN_COUNTRIES_ISO2, EN_TO_FR
import os
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "europa_SalaireMedianParNiveaudEducation_cleaned.csv")
...
def main():
    ...
    df_filtered = df[
        (df['sex'] == 'T') &
        (df['geo'].isin(EUROPEAN_COUNTRIES_ISO2))
    ].copy()
